# -*- coding: utf-8 -*-
# Generated by Django 1.9.3 on 2016-03-07 01:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Blog', verbose_name='Blog')),
            ],
            options={
                'ordering': ('-created',),
                'verbose_name': 'Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='blog.Post')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes_for_blog_postvote', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
