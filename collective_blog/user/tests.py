...
class TestProfileModelPerms(test.TransactionTestCase):
    ...
    def test_visible_email(self):
        ...
        self.assertIsNone(Profile.visible_email(moderator_without_perms, profile))
        self.assertIsNone(Profile.visible_email(user_with_perms, profile))
        self.assertIsNone(Profile.visible_email(user_with_perms2, profile))
        self.assertEqual(Profile.visible_email(superuser, profile), "a.b@example.com (%s)" % __('Only you can see the email'))
        self.assertIsNone(Profile.visible_email(disabled_superuser, profile))
        self.assertIsNone(Profile.visible_email(disabled_superuser2, profile))
        self.assertIsNone(Profile.visible_email(ordinary_user, profile))
